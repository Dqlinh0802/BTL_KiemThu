...
public class Sach {
    ...
    public Sach(String maSach, String tenSach, int soLuong, String namXuatBan, String moTaSach, TheLoaiSach theLoaiSach) {
        this.maSach = maSach;
    ...
    /**
     * @param theLoaiSach the theLoaiSach to set
     */
