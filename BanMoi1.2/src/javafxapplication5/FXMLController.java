...
public class FXMLController implements Initializable {
    ...
    public void ganVeNull3() {
        ...
        ngaySinh.setValue(LocalDate.of(1, 1, 2020));
        txtDoiTuong.setText("");
        txtBoPhan.setText("");
...
//        if((txtMaDocGia.getText().trim().equals("") && txtTenDocGia.getText().trim().equals(""))){
...
//        }
//        if(!(txtMaDocGia.getText().trim().equals("")) || !(txtTenDocGia.getText().trim().equals(""))){
//            alert.setContentText("Mã độc giả trống hoặc tên độc giả trống");
//            alert.show();
//       }
    }
    ...
    private void buildTable() throws SQLException {
        ...
        colSua.setCellFactory(evt -> {
            ...
            btn.setOnMouseClicked(et -> {
                ...
                // có bug sửa thì mở này ra dùng lại
                //mã loại sách
//                if(String.valueOf(q.getTheLoaiSach().getId()) != null)
//                    txtMa.setText(String.valueOf(q.getTheLoaiSach().getId()));
//                else
//                    txtMa.setText("null");
                thanhSuaSach.setVisible(true);
                co3 = false;
    ...
    private void buildTable3() throws SQLException {
        ...
        colMaDocGia.setMaxWidth(1f * Integer.MAX_VALUE * 25);
        colTenDocGia.setMaxWidth(1f * Integer.MAX_VALUE * 25);
        colDoiTuong.setMaxWidth(1f * Integer.MAX_VALUE * 15);
        colBoPhan.setMaxWidth(1f * Integer.MAX_VALUE * 35);
        
        bangDocGia.getColumns().addAll(colMaDocGia, colTenDocGia, colDoiTuong, colBoPhan);
    }
